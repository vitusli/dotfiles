...
class RemoveUpdate(bpy.types.Operator):
    bl_idname = "machin3.remove_hypercursor_update"
...
class UseFoundUpdate(bpy.types.Operator):
    bl_idname = "machin3.use_hypercursor_update"
    ...
    def description(cls, context, properties):
        return f"Install HyperCursor {properties.tail} from {properties.path}"
...
class ReScanUpdates(bpy.types.Operator):
    bl_idname = "machin3.rescan_hypercursor_updates"
